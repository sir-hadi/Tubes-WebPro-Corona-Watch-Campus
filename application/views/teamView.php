...
<div class="titleBar row">
    <div class="col d-flex align-items-end">
        <div class="titleCampus display-4">OUR TEAM</div>
    </div>
    <div class="titleTeamImage col-4"></div>
</div>
<!-- end of Title our team -->
...
$.getJSON("<?php echo base_url().'assets/dataTeam.json' ?>",function (data) {
        ...
        $.each(data, function (indexInArray, valueOfElement) { 
            if (indexInArray < 3) {
                ...
                +'<img src=" <?php echo base_url().'assets/' ?>'+valueOfElement.image+'" class="rounded-circle mx-auto d-block mt-4" style="width: 300px; height: 300px;" alt="...">'
                +'<div class="card-body">'
