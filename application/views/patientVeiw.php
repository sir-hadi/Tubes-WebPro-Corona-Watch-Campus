...
<div class="titleBar row">
    <div class="col d-flex align-items-end">
        <div class="titleText display-4">PETIENT</div>
    </div>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <!-- KONDISI IF KALO DIA USER -->
                <th scope="col">Action</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <th scope="col" class="lead">1</th>
                <th scope="col" class="lead">Made Meep</th>
                <th scope="col" class="lead">Meep Town</th>
                <th scope="col" class="lead">200 BC</th>
                <th scope="col" class="lead">Undefine</th>
                <th scope="col" class="lead">Mepp University</th>
                <th scope="col" class="lead">Sad :"</th>
                <!-- KONDISI IF KALO DIA USER -->
                <th scope="col">
                    <a href="" class="editPatient mr-4" data-toggle="modal" data-target="#editPatientModal1">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-0">
            ...
            <div class="modal-body">
                <!-- isi form ini -->
                <form method="POST" action="phpstuffgoeshere">
                    ...
                    <div class="form-group">
                        <label for="formGroupExampleInput">Brith date</label>
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Brith date" name="tglLahir" required>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput">Gender</label>
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Gender" name="jenisKelamin" required>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput">Campus</label>
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Campus" name="kampusAsal" required>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput">Condition</label>
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Condition" name="kondisi" required>
                    </div>
            </div>
...
<div class="modal fade" id="editPatientModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-0">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="php stuff goes here">
                    ...
                    <div class="form-group">
                        <label for="formGroupExampleInput">Patient birthplace</label>
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Patient birthplace" name="tempatLahir" required>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput">Brith date</label>
